...
@php
    $rekrutmenAktif  = \App\Models\Rekrutmen::where('is_aktif', true)->latest()->first();
    $sudahMendaftar  = $rekrutmenAktif
        ? \App\Models\Pendaftaran::where('user_id', auth()->id())
            ->where('rekrutmen_id', $rekrutmenAktif->id)->exists()
        : false;
@endphp

{{-- Banner peringatan jika belum mendaftar --}}
@if(!$sudahMendaftar)
<div class="alert" style="background:linear-gradient(135deg,#fff3cd,#ffe69c);border-left:5px solid #f6c23e;border-radius:10px;">
    <div class="d-flex align-items-start">
        <i class="fas fa-exclamation-triangle fa-2x text-warning mr-3 mt-1"></i>
        <div>
            <strong style="font-size:15px;">⚠️ Periksa kembali data Anda sebelum mendaftar!</strong>
            <p class="mb-0 mt-1 text-dark">
                Pastikan semua data yang diisi sudah <strong>benar dan sesuai dokumen resmi</strong>.
                Setelah Anda menekan tombol <strong>Daftar</strong>, biodata dan dokumen
                <strong>tidak dapat diubah lagi</strong>. Jika ada kesalahan data setelah mendaftar,
                hubungi panitia secara langsung.
            </p>
        </div>
    </div>
</div>
@else
{{-- Banner jika sudah mendaftar — form dikunci --}}
<div class="alert alert-danger" style="border-left:5px solid #e3342f;border-radius:10px;">
    <div class="d-flex align-items-start">
        <i class="fas fa-lock fa-2x text-danger mr-3 mt-1"></i>
        <div>
            <strong style="font-size:15px;">🔒 Biodata Terkunci</strong>
            <p class="mb-0 mt-1">
                Anda sudah mengirimkan pendaftaran. Biodata <strong>tidak dapat diubah</strong>.
                Jika ada kesalahan data, silakan hubungi panitia secara langsung.
            </p>
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nik"
                           ...
                           value="{{ old('nik', $profil->nik) }}" maxlength="16"
                           {{ $sudahMendaftar ? 'disabled' : 'required' }}>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="golongan_darah" class="form-control" {{ $sudahMendaftar ? 'disabled' : '' }}>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea name="alamat_lengkap"
                              ...
                              rows="2" {{ $sudahMendaftar ? 'disabled' : 'required' }}>{{ old('alamat_lengkap', $profil->alamat_lengkap) }}</textarea>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea name="prestasi" class="form-control" rows="2"
                              placeholder="Contoh: Juara 1 PBB tingkat kecamatan 2024"
                              {{ $sudahMendaftar ? 'disabled' : '' }}>{{ old('prestasi', $profil->prestasi) }}</textarea>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="form-group">
                    ...
                    <input type="text" name="nama_ortu"
                           ...
                           value="{{ old('nama_ortu', $profil->nama_ortu) }}"
                           {{ $sudahMendaftar ? 'disabled' : 'required' }}>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="hp_ortu"
                           class="form-control @error('hp_ortu') is-invalid @enderror"
                           value="{{ old('hp_ortu', $profil->hp_ortu) }}"
                           {{ $sudahMendaftar ? 'disabled' : 'required' }}>
            ...
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <select name="hubungan_ortu"
                            class="form-control @error('hubungan_ortu') is-invalid @enderror"
                            {{ $sudahMendaftar ? 'disabled' : 'required' }}>
                        <option value="">Pilih...</option>
...
<div class="d-flex justify-content-between mb-4">
    ...
    @else
    <span class="btn btn-secondary px-5 disabled">

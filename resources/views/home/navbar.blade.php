...
<nav id="navbar">
  ...
  <ul class="nav-links">
    <li><a href="{{ url('/') }}#tentang"     class="{{ request()->is('/') ? '' : '' }}">Tentang</a></li>
    <li><a href="{{ url('/') }}#pendaftaran">Pendaftaran</a></li>
    <li><a href="{{ url('/') }}#syarat">Syarat</a></li>
    <li>
      <a href="{{ route('berita.index') }}"
         style="{{ request()->routeIs('berita.*') ? 'color:#cc0000;' : '' }}">
        Berita
      </a>
    </li>
    <li>
      <a href="{{ route('galeri.index') }}"
         style="{{ request()->routeIs('galeri.*') ? 'color:#cc0000;' : '' }}">
        Galeri
      </a>
    </li>
    <li>
      <a href="{{ route('pengumuman') }}"
         style="{{ request()->routeIs('pengumuman') ? 'color:#cc0000;' : '' }}">
        Pengumuman
      </a>
    </li>
...
<div class="nav-mobile" id="navMobile">
  <ul>
    ...
    <li><a href="{{ route('berita.index') }}" onclick="toggleMenu()">Berita</a></li>
    <li><a href="{{ route('galeri.index') }}" onclick="toggleMenu()">Galeri</a></li>
